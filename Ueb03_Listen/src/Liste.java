...
public class Liste<T>
{
	...
	public void verketten(Liste<T> zweiteListe)
	{
		...
		this.ende=zweiteListe.getEnde();
		zweiteListe.anfang=null;
		zweiteListe.ende=null;
		zweiteListe.vorgaengerAktuellerZeiger=null;
	}
	...
	public int loescheWerte(T victim)
	{
		...
		vorgaengerAktuellerZeiger=null;
		Link<T> hilfszeiger=this.anfang;
		
		while (hilfszeiger!=null)
		{
		if (victim.equals(hilfszeiger.getDaten()))
		{
			if (vorgaengerAktuellerZeiger==null)
			{
				anfang=hilfszeiger.naechster;
				anzGeloeschte++;
			}
			else
			{
			vorgaengerAktuellerZeiger.naechster=hilfszeiger.naechster;
			
			anzGeloeschte++;
			}
		
		}
		vorgaengerAktuellerZeiger=hilfszeiger;
